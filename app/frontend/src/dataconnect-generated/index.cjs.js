...
const listUserProjectsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'ListUserProjects', inputVars);
}
listUserProjectsRef.operationName = 'ListUserProjects';
exports.listUserProjectsRef = listUserProjectsRef;

exports.listUserProjects = function listUserProjects(dcOrVars, varsOrOptions, options) {

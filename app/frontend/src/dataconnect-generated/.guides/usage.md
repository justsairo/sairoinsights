...
```ts
import { useCreateUser, useCreateProject, useListUserProjects, useDeleteReport } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useListUserProjects(listUserProjectsVars);
...
```js
import { createUser, createProject, listUserProjects, deleteReport } from '@dataconnect/generated';
...
// Operation ListUserProjects:  For variables, look at type ListUserProjectsVars in ../index.d.ts
